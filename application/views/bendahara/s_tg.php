                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                $total =  $jml_a['jmlAnggota'] - $jml_ta['jml_ta'];
                                            ...
                                            foreach ($ta as $r) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a class="btn btn-danger" href="<?= base_url("Bendahara/del_tg_a/" . $r['no_tg'] . "/" . $r['no_ta']) ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data tagihan anggota ini ?')">
