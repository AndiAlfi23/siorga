                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" method="POST" action="<?= base_url("Kegiatan") ?>">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" name="kegiatan" id="kegiatan" value="<?= set_value('kegiatan') ?>" placeholder="Nama Kegiatan"></textarea>
